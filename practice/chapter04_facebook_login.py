...
# * : 지속적으로 사용 불가능.. 페이스북 보안을 위해 로그인버튼의 선택자를 수시로 변경함...ㅠ
...
driver.find_element_by_id('email').send_keys('shju0317@naver.com')
driver.find_element_by_id('pass').send_keys('')
driver.find_element_by_id('u_0_e').click() # 로그인 버튼 ID값이 보안 때문에 수시로 변경